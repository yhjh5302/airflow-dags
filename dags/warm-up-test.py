...
with DAG(
    ...
    params={
        ...
        "namespace": Param(default="llm-test", type="string", pattern=r"^[a-z0-9]([-a-z0-9]*[a-z0-9])?$"),
        ...
        "cmd": Param(default="cd horovod_test && python3 train.py --epochs 10", type="string", format="textarea"),
